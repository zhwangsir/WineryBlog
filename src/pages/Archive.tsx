...
import { Calendar, Tag, Folder, Pin } from 'lucide-react';
...
export const Archive: React.FC = () => {
  ...
  }, [categoryFilter, tagFilter, posts]);
  ...
  return (
    <>
      <SEO 
        title={`${pageTitle} - ${config?.title || 'WineryBlog'}`}
        description={`${pageTitle}，共 ${filteredPosts.length} 篇文章`}
